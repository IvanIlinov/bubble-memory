    ...
    <div className="flex flex-col items-center gap-3 -ml-4">
      <div className="relative">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, rgba(61,220,196,0.3) 0%, transparent 70%)",
          }}
        />
        ...
        <div
          ...
          style={{
            ...
            boxShadow:
              "0 0 0 1px rgba(255,255,255,0.08), inset 0 1px 0 rgba(255,255,255,0.06), 0 24px 48px -16px rgba(0,0,0,0.6)",
