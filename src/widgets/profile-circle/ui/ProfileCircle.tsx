...
export function ProfileCircle({
  ...
  const progress = Math.min(totalRepetitions / yearTarget, 1);
    ...
    <div className="flex flex-col items-center gap-3">
      <div className="relative">
        ...
        <div
          ...
          role="img"
          aria-label={`Профиль: ${progressPercent}% прогресса, ${totalRepetitions} повторений`}
          style={{
        ...
        >
          <svg viewBox="0 0 100 100" className="absolute inset-0 h-full w-full -rotate-90">
            <defs>
              <linearGradient id="profileRingGradient" x1="1" y1="0" x2="0" y2="1">
          ...
          <div className="flex flex-col items-center justify-center">
            <span className="font-display text-4xl font-semibold text-foam">
              {progressPercent}%
            </span>
            <span className="mt-1 text-[11px] uppercase tracking-wide text-foam-muted">
              {totalRepetitions} / {yearTarget}
            </span>
          </div>
        </div>
      </div>
